  ...
  var body: some View {
    GeometryReader { geometry in
      ...
      let viewportWidth: Double =
        imageAspect > viewAspect ? geometry.size.width : geometry.size.height * imageAspect
      let viewportHeight: Double =
        imageAspect > viewAspect ? geometry.size.width / imageAspect : geometry.size.height
      ...
      ZStack {
        ...
        .onLongPressGesture {
          guard allowsUITestImageLongPress,
            let firstBox = detectedBoxes.first
          else { return }
      ...
      .gesture(
        MagnificationGesture()
          ...
          .onEnded { _ in
            ...
            accumulatedPan = clampedPan(
              .zero, accumulatedPan, for: viewportSize, zoom: clampedZoom(totalZoom))
          }
      )
      .simultaneousGesture(
        DragGesture()
