...
struct CalculatorTests {
  ...
  /// Tests single pixel at one meter returns one square millimeter.
  @Test func calculateArea_singlePixelAtOneMeter_returnsOneSquareMillimeter() throws {
    ...
    let depth = try makeDepthPixelBuffer(
      width: 2, height: 2,
      values: [
        1, 1,
        1, 1,
  ...
  /// Tests box max boundary does not include extra pixel.
  ...
  /// Tests continuous weighting both pixels contribute.
  ...
  /// Tests partial alpha contributes proportionally.
  ...
  /// Tests full alpha matches expected.
  ...
  /// Tests median depth resists outlier.
  ...
  /// Tests all depths invalid returns zero.
  ...
  /// Tests low confidence depth excluded from depth pool.
  ...
  /// Tests nil depth map returns zero.
  ...
  /// Tests nil intrinsics returns zero.
  ...
  /// Tests empty bounding boxes returns zero.
  ...
  /// Tests zero focal length returns zero.
  ...
  /// Tests two adjacent pixels returns one millimeter.
  ...
  /// Tests single pixel returns zero.
  ...
  /// Tests calculate metrics returns both area and diameter.
  ...
  /// Tests nil depth map returns zeros.
...
struct CalculatorHelperTests {
  ...
  /// Tests up orientation returns original.
  ...
  /// Tests down orientation returns original.
  ...
  /// Tests right orientation swaps dimensions.
  ...
  /// Tests left orientation swaps dimensions.
  ...
  /// Tests up orientation is identity.
  ...
  /// Tests right orientation maps as expected.
  ...
  /// Tests left orientation maps as expected.
  ...
  /// Tests down orientation is point reflection.
  ...
  /// Tests up mirrored flips horizontally.
  ...
  /// Tests rect inside returns inclusive bounds.
  ...
  /// Tests rect overflows image clamps to edges.
  ...
  /// Tests rect entirely outside returns nil.
  ...
  /// Tests zero sized rect returns nil.
  ...
  /// Tests two points returns input unchanged.
  ...
  /// Tests square corners returns all four vertices.
  ...
  /// Tests interior point is omitted.
  ...
  /// Tests collinear points returns only endpoints.
  ...
  /// Tests two points returns scaled squared distance.
  ...
  /// Tests unit square returns diagonal squared.
  ...
  /// Tests scales by inverse focal lengths.
