...
struct OverviewAppStateTests {
  ...
  /// Tests that available body parts are unique and sorted.
  ...
  func availableBodyPartsAreUniqueAndSorted() {
    ...
    person.moles = [
      Mole(
        name: "A", bodyPart: "Back", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
      Mole(
        name: "B", bodyPart: "Arm", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
    ]
  ...
  /// Tests that displayed moles filter by selected body parts.
  ...
  func displayedMolesFilterByBodyPart() {
    ...
    person.moles = [
      Mole(
        name: "Back One", bodyPart: "Back", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
      Mole(
        name: "Arm One", bodyPart: "Arm", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
    ]
  ...
  /// Tests that displayed moles update as filters change.
  ...
  func displayedMolesUpdateWhenChangingSelectedBodyParts() {
    ...
    person.moles = [
      ...
      Mole(
        ...
        nextDueDate: nil, person: person),
      Mole(
        name: "Leg One", bodyPart: "Leg", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
    ]
  ...
  /// Tests that displayed moles sort alphabetically regardless of case.
  ...
  func displayedMolesSortAlphabetically() {
    ...
    person.moles = [
      Mole(
        name: "zeta", bodyPart: "Back", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
      Mole(
        name: "Alpha", bodyPart: "Back", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
      Mole(
        name: "beta", bodyPart: "Back", isReminderActive: false, reminderFrequency: nil,
        nextDueDate: nil, person: person),
    ]
  ...
  /// Tests that displayed moles sort by most recent scan.
  ...
  func displayedMolesSortByRecentScan() {
    ...
    let veryOldMole = makeMole(
      name: "Very Old", bodyPart: "Back", captureDates: [day0], person: person)
  ...
  /// Tests that displayed moles sort by next due date.
  ...
  /// Tests that displayed moles filter by multiple body parts.
  ...
  /// Tests that displayed moles returns empty when no match.
  ...
  /// Tests that latest scan returns newest.
  ...
  func latestScanReturnsNewestScan() {
    ...
    let mole = makeMole(
      name: "Back", bodyPart: "Back", captureDates: [day0, day20, day10], person: person)

    #expect(state.latestScan(for: mole)?.captureDate == day20)
  }

  /// Tests that latest scan returns nil when none exist.
  ...
  /// Tests that initialize selection picks first person.
  ...
  /// Tests that initialize selection does not override.
  ...
  /// Tests select next and previous person updates.
  ...
  /// Tests select next and previous respect bounds.
  ...
  /// Tests select mole updates selected mole and id.
