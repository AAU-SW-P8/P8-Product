...
final class InjectedPicturesUITests: XCTestCase {
    ...
    func testCapturedImageAddedToExistingMoleCanCancelAndNotAppearInOverview() {
        ...
        XCTAssertTrue(useMockDetectionButton.waitForExistence(timeout: 3), "Should return to mocked segmentation view after cancelling existing mole selection")
    ...
    func testCapturedImageCreateNewMoleCanCancelAndNotAppearInOverview() {
        ...
        XCTAssertTrue(useMockDetectionButton.waitForExistence(timeout: 3), "Should return to mocked segmentation view after cancelling new mole creation")
