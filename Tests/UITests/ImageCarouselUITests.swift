...
final class ImageCarouselUITests: XCTestCase {
  ...
  private func assertCarousel(
    ...
    let diameterMatches = decimalVariants.contains {
      carousel.staticTexts["Diameter: \($0) mm"].exists
    }
  ...
  func testLeftAndRightCarouselsTrackSelectionIndependently() {
    ...
    let movedLeftDiameter = observedDiameter(
      in: leftCarousel, candidates: ["4.2", "4,2", "4.8", "4,8"])
