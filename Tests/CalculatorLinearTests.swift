...
struct DistanceLookupTests {
  ...
  /// Tests exact entry returns entry value.
  ...
  /// Tests between entries interpolates linearly.
  ...
  /// Tests below range clamps to first entry.
  ...
  /// Tests above range clamps to last entry.
  ...
  /// Tests init sorts entries by distance.
  ...
  /// Tests empty table returns zero.
...
struct CalculatorLinearTests {
  ...
  /// Tests single pixel uses lookup value at median depth.
  ...
  /// Tests median depth drives lookup.
  ...
  /// Tests depth below calibrated range clamps to first entry.
  ...
  /// Tests two adjacent pixels uses lookup value.
