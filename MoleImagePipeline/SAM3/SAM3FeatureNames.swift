...
enum SAM3FeatureNames {
  ...
  enum Decoder {
    ...
    // Decoder input keys.
    /// The input name for FPN feature map 0.
    static let fpnFeat0Input: String = "fpn_feat0"
    /// The input name for FPN feature map 1.
    static let fpnFeat1Input: String = "fpn_feat1"
    /// The input name for FPN feature map 2.
    static let fpnFeat2Input: String = "fpn_feat2"
    /// The input name for positional encoding.
    static let visPosInput: String = "vis_pos"
    /// The input name for text features.
    static let textFeatInput: String = "text_features"
    /// The input name for text mask.
